"""
Django settings for lively_union_46889 project.
...
ROOT_URLCONF = 'lively_union_46889.urls'
...
WSGI_APPLICATION = 'lively_union_46889.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lively_union_46889 API",
    "DESCRIPTION": "API documentation for lively_union_46889 App",
    "VERSION": "v1",
}
